#pragma checksum "E:\Angular_Projects\_coreUSer - Copy\UserLive\Views\NewUser\InsertMaster.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e912557bf14773c4572dd49696d448e82740d4d6"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e912557bf14773c4572dd49696d448e82740d4d6", @"/Views/NewUser/InsertMaster.cshtml")]
    ...
    public class Views_NewUser_InsertMaster : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<UserLive.Models.NewUserVM>
    {
        ...
        {
#line 2 "E:\Angular_Projects\_coreUSer - Copy\UserLive\Views\NewUser\InsertMaster.cshtml"
...
<div class=""container"">
    ...
    <div class=""row"">
        <div class=""col-lg-5"">
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "fed8b15f811e4c0d853a41e837b95eb1", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "62a9bdbabdab41e48c0097a783e4fe66", async() => {
                }
                );
...
");
            EndContext();
#line 257 "E:\Angular_Projects\_coreUSer - Copy\UserLive\Views\NewUser\InsertMaster.cshtml"
...
#line 259 "E:\Angular_Projects\_coreUSer - Copy\UserLive\Views\NewUser\InsertMaster.cshtml"
...
#line hidden
            ...
            EndContext();
#line 263 "E:\Angular_Projects\_coreUSer - Copy\UserLive\Views\NewUser\InsertMaster.cshtml"
                }
    ...
    <div class=""modal fade"" id=""myModal"" role=""dialog"">
        <div class=""modal-dialog modal-lg"">
            <div class=""modal-content"">
                ");
            EndContext();
            BeginContext(10338, 3394, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "36106e51cd664538a4e3b287bfcfc608", async() => {
                BeginContext(10388, 385, true);
                WriteLiteral(@"
...
<script>
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                updated_dropdown = $.map(result, function (val, key) {
                    ...
                    if (val._countryId == userDropDownVal) {
                        return val;
                    }
                    //console.log(""val=> "", val)
                })
                ...
                for (var i = 0; i < updated_dropdown.length; i++) {
                    dropdown += '<option value=""' + updated_dropdown[i]._provinceId + '"">' + updated_dropdown[i]._provinceName + '</option>';
                }
                $(""#provinceList,#proListEdit"").html(dropdown)
                console.");
            WriteLiteral(@"log(""ProvinceListVal(Country)=> "", userDropDownVal)
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                for (var i = 0; i < result.length; i++) {
                    dropdown += '<option value=""' + result[i]._countryId + '"">' + result[i]._countryName + '</option>';
                }
    ...
    function SkillsList() {
        $.ajax({
            ...
            success: function (result) {
                ...
                var checkbox = '';
                for (var i = 0; i < result.length; i++) {
                    checkbox += '<label class=""control-label check"">' + result[");
            WriteLiteral(@"i]._skillName + '<input class=""form-control"" type=""checkbox"" id=""' + result[i]._skillId + '"" value=""' + result[i]._skillId + '"" />' + '</label>&nbsp;';
                }
    ...
    function DeleleRecord(id) {
        if (c");
            WriteLiteral(@"onfirm(""Are you sure you want to delete this rcrd??"")) {
            $.ajax({
    ...
    function RcrdGetbyID(id) {
        $.ajax({
            ...
            success: function (result) {
                cons");
            WriteLiteral(@"ole.log(""Edit Result=> "", result)
                ...
                var countryId = parseInt(result._userCountry)
                //var provinceId = parseInt(result._userProvince)

                //map saved chkBoxes values
                var editchecklist = JSON.parse(result._uskillIds)
                ...
                $(""#co");
            WriteLiteral(@"untryListEdit option[value="" + countryId + ""]"").attr(""selected"", true).val(countryId)
    ...
    $(""#btnUpdate"").click(function () {
       ...
       ");
        ...
        data.append(""_userCountry"", userDropDownVal)
    ...
    ");
            WriteLiteral(@"    if (selected.length > 0) {
        ...
        html += '<td id=""_userDropDown"">' + userDropDown + '</td>';
        html += '</tr>';
        ...
        $('.tbody').each(function () {
            ...
            pushedData._userCountry = userDropDownVal
            pushedData._countryName = userDropDown
            pushedData._uskillIds = JSON.string");
            WriteLiteral(@"ify(selected)

            //pushedData._userProvince = provinceDropDownVal
            //pushedData._provinceName = provinceDropDownText

            console.log(""Inside table => "", pushedData._userName + "" | "" + pushedData._userEmail + "" | "" + pushedData._userPwd + "" | "" + pushedData._userPhone + "" | "" + pushedData._userCountry + "" | "" + pushedData._countryName + "" | "" + pushedData._uskillIds )
